        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              }} className="text-foreground hover:text-primary transition-colors">Zentrum für das Engineering Smarter Produkt-Service Systeme (ZESS)
Hans-Dobbertin-Str. 8
44803 Bochum, Germany</button>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://github.com/NexuFed-AI" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors" aria-label="GitHub" onClick={() => trackEvent("click", "Footer", "GitHub")}>
