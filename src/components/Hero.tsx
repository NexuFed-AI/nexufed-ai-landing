  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-40">
        ...
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <line x1="35%" y1="30%" x2="60%" y2="25%" stroke="url(#lineGradientSecure)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "1s"
        }} />
          <line x1="60%" y1="25%" x2="80%" y2="35%" stroke="url(#lineGradient)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "2s"
        }} />
          <line x1="15%" y1="20%" x2="20%" y2="50%" stroke="url(#lineGradientSecure)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "0.5s"
        }} />
          <line x1="20%" y1="50%" x2="45%" y2="60%" stroke="url(#lineGradient)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "1.5s"
        }} />
          <line x1="45%" y1="60%" x2="70%" y2="55%" stroke="url(#lineGradient)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "2.5s"
        }} />
          <line x1="70%" y1="55%" x2="85%" y2="65%" stroke="url(#lineGradientSecure)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "3s"
        }} />
          <line x1="35%" y1="30%" x2="45%" y2="60%" stroke="url(#lineGradient)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "0.8s"
        }} />
          <line x1="60%" y1="25%" x2="70%" y2="55%" stroke="url(#lineGradientSecure)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "1.8s"
        }} />
          <line x1="20%" y1="50%" x2="35%" y2="75%" stroke="url(#lineGradient)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "2.2s"
        }} />
          <line x1="35%" y1="75%" x2="65%" y2="80%" stroke="url(#lineGradient)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "2.8s"
        }} />
          <line x1="65%" y1="80%" x2="85%" y2="65%" stroke="url(#lineGradientSecure)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "1.2s"
        }} />
          <line x1="45%" y1="60%" x2="65%" y2="80%" stroke="url(#lineGradient)" strokeWidth="1.5" className="animate-pulse-line" style={{
          animationDelay: "3.5s"
        }} />
        </svg>
        ...
        <div className="absolute top-[30%] left-[35%]">
          <Lock className="absolute w-4 h-4 -translate-x-1/2 -translate-y-1/2 text-primary/20" style={{
          animationDelay: "1s"
        }} />
          <div className="w-2.5 h-2.5 bg-primary rounded-full animate-pulse-node shadow-[0_0_12px_hsl(var(--primary))]" style={{
          animationDelay: "1s"
        }} />
        </div>
        ...
        <div className="absolute top-[25%] left-[60%]">
          ...
          <div className="absolute inset-0 w-8 h-8 -translate-x-[12px] -translate-y-[12px] bg-primary/10 rounded-full animate-pulse-halo" style={{
          animationDelay: "2s"
        }} />
          <div className="w-2 h-2 bg-primary rounded-full animate-pulse-node shadow-[0_0_10px_hsl(var(--primary))]" style={{
          animationDelay: "2s"
        }} />
        </div>
        ...
        <div className="absolute top-[50%] left-[20%]">
          ...
          <div className="absolute inset-0 w-9 h-9 -translate-x-[13px] -translate-y-[13px] bg-primary/10 rounded-full animate-pulse-halo" style={{
          animationDelay: "1.5s"
        }} />
          <div className="w-2.5 h-2.5 bg-primary rounded-full animate-pulse-node shadow-[0_0_12px_hsl(var(--primary))]" style={{
          animationDelay: "1.5s"
        ...
        <div className="absolute top-[60%] left-[45%]">
          ...
          <div className="w-3 h-3 bg-primary rounded-full animate-pulse-node shadow-[0_0_15px_hsl(var(--primary))]" style={{
          animationDelay: "2.5s"
        }} />
        </div>
      ...
      <div className="container mx-auto px-6 py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Button size="lg" variant="outline" onClick={() => scrollToSection("approach")} className="text-lg border-2">
              Learn more
            </Button>
          </div>
