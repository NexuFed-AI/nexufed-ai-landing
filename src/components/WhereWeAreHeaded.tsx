...
const WhereWeAreHeaded = () => {
  const useCases = [{
    ...
    description: "pumps, motors, fans and compressors where downtime is costly"
  }, {
    title: "OEM-level condition monitoring",
    description: "machine builders offering smart monitoring to customers"
  }, {
    title: "Privacy-sensitive environments",
    description: "sites where raw data cannot leave the plant"
  }, {
    title: "Future domains",
    description: "quality assurance, robotics, and other industrial AI applications"
  }];
  const goals = [{
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {useCases.map((useCase, index) => <li key={index} className="flex items-start gap-3">
